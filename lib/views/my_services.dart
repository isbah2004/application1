      ...
      mobile: Column(
        children: [
          ...
          InkWell(
            ...
            child: buildAnimatedContainer(
              title: AppText.acheivement4,
              hover: acheivement4,
              acheivementDescription: AppText.acheivementDescription4,
            ),
          ),
        ],
      ),
        ...
        children: [
          Text(
            ...
            style: AppTextStyles.montserratStyle(
                color: Colors.white, fontSize: 18.0),textAlign: TextAlign.start,
          ),
          Constants.sizedBox(height: 12.0),
          Text(
            acheivementDescription,
            style: AppTextStyles.normalStyle(fontSize: 12.0),
